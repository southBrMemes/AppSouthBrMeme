package com.example.dev.southbrmemes.Presenter.Rest.Service.Delete
 ...
 */
object MemeDelete {
    fun delete(id: Int, activity: Activity, success: (note: Response<Return?>) -> Unit,
        ...
        val call = retrofit.delete(id,SessionManager(activity).getPreferences(SessionManager.TOKEN))

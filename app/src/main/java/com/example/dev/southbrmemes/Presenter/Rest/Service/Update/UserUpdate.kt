package com.example.dev.southbrmemes.Presenter.Rest.Service.Update
...
object UserUpdate {
    ...
    fun update(user: User, activity: Activity, success: (note: Response<Return?>) -> Unit,
        ...
        val call = retrofit.update(user, SessionManager(activity).getPreferences(SessionManager.TOKEN))

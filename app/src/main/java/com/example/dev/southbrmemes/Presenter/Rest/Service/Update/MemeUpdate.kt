 ...
 */
object MemeUpdate {
    fun update(meme: Meme, activity: Activity, success: (note: Response<Return?>) -> Unit,
        ...
        val call = retrofit.update(meme, SessionManager(activity).getPreferences(SessionManager.TOKEN))
